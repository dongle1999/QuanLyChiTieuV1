...
public class DompetActivity extends AppCompatActivity
    ...
    public void LoadListView() {
        ...
        tvValuePendapatan.setText(String.valueOf(TotalPendapatan)+" .Vnd");
        tvValuePengeluaran.setText( String.valueOf(TotalPengeluaran)+" .Vnd");
    ...
    public void loadKategori() {
        String[] ITEMS = {"Tất cả danh mục", "Thu nhập", "Chi Tiêu"};
