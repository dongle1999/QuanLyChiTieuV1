package com.example.money.management.report;
...
import com.example.money.management.DompetActivity;
import com.example.money.management.KategoriPendapatan;
import com.example.money.management.KategoriPengeluaran;
import com.example.money.management.MainActivity;
import com.example.money.management.R;
import com.example.money.management.database.DataHelper;
...
public class ReportActivity extends AppCompatActivity
    ...
    public void settingUpchart() {
        ...
        mChartRevenue.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                Toast.makeText(getApplicationContext(),
                        String.valueOf(Math.round(pe.getValue())) + " Thu nhập trong danh mục " +
                                pe.getLabel(),
        ...
        mChartExpense.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                PieEntry pe = (PieEntry) e;
                Toast.makeText(getApplicationContext(),
                        String.valueOf(Math.round(pe.getValue())) + " Chi tiêu theo danh mục " +
                                pe.getLabel(),
                        Toast.LENGTH_LONG).show();
            }
    ...
    public void loadMonth() {
        ...
        tospinner.add(0, "Chọn Tháng - Năm");
        ...
        spinMonth.setOnItemSelectedListener(new MaterialSpinner.OnItemSelectedListener<String>() {
            ...
            public void onItemSelected(MaterialSpinner view, int position, long id, String item) {
                if (position != 0) {
                    ...
                    Toast.makeText(getApplicationContext(), "Báo cáo tháng "+Bulan[position-1], Toast.LENGTH_SHORT).show();
    ...
    public void setDataRevenueToChart(){
        if (AdaDataPendapatan != 0) {
            ...
            String center = String.valueOf(total) + " Thu nhập \nvới Total :\n " + String.valueOf(TotalPendapatan)+".Vnd";
            ...
            Toast.makeText(getApplicationContext(), "Không có dữ liệu thu nhập", Toast.LENGTH_SHORT).show();
    ...
    public void setDataExpenseToChart(){
        if (AdaDataPengeluaran != 0) {
            ...
            String center = String.valueOf(total) + " Chi tiêu \nvới Total :\n" + String.valueOf(TotalPengeluaran)+".Vnd";
            ...
            Toast.makeText(getApplicationContext(), "Không có dữ liệu chi tiêu", Toast.LENGTH_SHORT).show();
    ...
    private void toSaveChartRevenue() {
        ...
        String name = "Báo cáo thu nhập_" + timeStamp;
        try {
            mChartRevenue.saveToGallery(name, 100);
            Toast.makeText(getApplicationContext(), "Lưu thành công báo cáo thu nhập", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
    ...
    private void toSaveChartExpense() {
        String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(Calendar.getInstance().getTime());
        String name = "Báo cáo chi tiêu" + timeStamp;
        try {
            mChartExpense.saveToGallery(name, 100);
            Toast.makeText(getApplicationContext(), "Lưu thành công báo cáo chi phí", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            System.out.println("Lưu thất bại "+e);
        }
    }
